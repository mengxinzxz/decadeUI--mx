...
decadeModule.import(function (lib, game, ui, get, ai, _status) {
  decadeUI.content = {
    chooseGuanXing: function (
          ...
          for (var i = 0; i < this.cards.length; i++) {
            ...
            if (this.orderCardsList[i].length) {
              cards.sort(function (a, b) {
                ...
                aIndex =
                  aIndex >= 0 ? aIndex : guanXing.orderCardsList[i].length;
                bIndex =
                  bIndex >= 0 ? bIndex : guanXing.orderCardsList[i].length;
              ...
              if (guanXing.selected) {
                var y =
                  (this.offsetHeight *
                    ...
                    decadeUI.zooms.card) /
                    2 -
                  (guanXing.cards[0].contains(guanXing.selected) ? 12 : -12);
      ...
      decadeUI.game.wait();
      guanXing.infohide =
        infohide == null ? (game.me == player ? false : true) : infohide;
