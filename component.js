...
decadeModule.import(function (lib, game, ui, get, ai, _status) {
  decadeUI.component = {
    ...
    chatBox: function () {
      ...
      box.operation.fold = decadeUI.dialog.create(
        "fold-button",
        box.operation,
        "button"
      );
      box.operation.input = decadeUI.dialog.create(
        "chat-input",
        box.operation,
        "input"
      );
      box.operation.sticker = decadeUI.dialog.create(
        "sticker-button",
        box.operation,
        "button"
      );
      box.operation.send = decadeUI.dialog.create(
        "send-button",
        box.operation,
        "button"
      );
