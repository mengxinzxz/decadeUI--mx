app.import(function (lib, game, ui, get, ai, _status, app) {
  game.ui_identityShow_update = function () {
    ...
    if (
      ...
      if (enemy > 0)
        str += '<font color="#ff0000">' + "虎" + "</font> x " + enemy + "  ";
      if (friend > 0)
        str += '<font color="#00ff00">' + "龙" + "</font> x " + friend + "  ";
    } else {
    ...
    identityShow.innerHTML =
      '<span style="font-family:shousha; font-size: 17.0px;font-weight:500;text-align: right; line-height: 20px; color: #C1AD92;text-shadow:none;">' +
      str +
      "</span>"; /*图层1*/
    identityShowx.innerHTML =
      '<span style="font-family:shousha; font-size: 17.0px;font-weight:500;text-align: right; line-height: 20px; color: #2D241B; -webkit-text-stroke: 2.7px #322B20;text-shadow:none;">' +
      str +
      "</span>"; /*图层2*/
  };
    ...
    create: {
      ...
      confirm: function () {
        ...
        confirm.node.cancel.innerHTML =
          "<image style=width: 80px height 15px src=" +
          lib.assetURL +
        ...
        if (ui.skills2 && ui.skills2.skills.length) {
          ...
          for (var i = 0; i < skills.length; i++) {
            ...
            if (skills[i] == "_recasting") {
              item.innerHTML =
                "<img style=width:70px height:15px src=" +
                lib.assetURL +
                "extension/十周年UI/shoushaUI/lbtn/images/uibutton/CZ.png>";
            } else {
